...
public class EngineConfig {
    ...
    private final Tunable rfpNoisyMoveMargin     = new Tunable("RfpNoisyMoveMargin", 30, 0, 50, 10);
    ...
    public Set<Tunable> getTunables() {
        return Set.of(
                ...
                lmpImpBase, lmpImpScale, lmrFailHighCount, hindsightExtLimit, rfpNoisyMoveMargin
        );
    }
    ...
    public int rfpNoisyMoveMargin() {
        return rfpNoisyMoveMargin.value;
    }
