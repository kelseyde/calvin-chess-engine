...
public class EngineConfig {
    ...
    private final Tunable aspMargin              = new Tunable("AspMargin", 19, 0, 250, 25);
    ...
    private final Tunable fpMargin               = new Tunable("FpMargin", 166, 0, 500, 25);
    ...
    private final Tunable seeQuietMargin         = new Tunable("SeeQuietMargin", -35, -250, -10, 25);
    private final Tunable seeNoisyMargin         = new Tunable("SeeNoisyMargin", -28, -250, -10, 25);
    private final Tunable seeNoisyOffset         = new Tunable("SeeNoisyOffset", 11, -100, 200, 50);
    ...
    private final Tunable seeHistoryDivisor      = new Tunable("SeeHistoryDivisor", 125, 50, 250, 25);
    private final Tunable qsFpMargin             = new Tunable("QsFpMargin", 109, 0, 250, 10);
    private final Tunable qsSeeThreshold         = new Tunable("QsSeeThreshold", 4, -300, 300, 100);
    private final Tunable rfpDepth               = new Tunable("RfpDepth", 9, 0, 12, 1);
    private final Tunable rfpMargin              = new Tunable("RfpMargin", 84, 0, 250, 25);
    private final Tunable rfpImpMargin           = new Tunable("RfpImpMargin", 46, 0, 250, 25);
    ...
    private final Tunable lmrDivisor             = new Tunable("LmrDivisor", 303, 200, 400, 10);
    ...
    private final Tunable lmrPvNode              = new Tunable("LmrPvNode", 935, 0, 2048, 150);
    private final Tunable lmrCutNode             = new Tunable("LmrPvNode", 0, 0, 2048, 150);
    private final Tunable lmrNotImproving        = new Tunable("LmrNotImproving", 35, 0, 2048, 150);
    private final Tunable lmrQuietHistoryDiv     = new Tunable("LmrQuietHistoryDiv", 3026, 1536, 6144, 1000);
    private final Tunable lmrNoisyHistoryDiv     = new Tunable("LmrNoisyHistoryDiv", 3177, 1536, 6144, 1000);
    ...
    private final Tunable razorMargin            = new Tunable("RazorMargin", 485, 0, 600, 10);
    private final Tunable hpMaxDepth             = new Tunable("HpMaxDepth", 5, 0, 10, 1);
    private final Tunable hpMargin               = new Tunable("HpMargin", -2188, -4000, -100, 50);
    private final Tunable hpOffset               = new Tunable("HpOffset", -1056, -3000, 0, 50);
    private final Tunable ttExtensionDepth       = new Tunable("TtExtDepth", 6, 0, 12, 1);
    private final Tunable quietHistBonusMax      = new Tunable("QuietHistBonusMax", 1255, 100, 2000, 100);
    private final Tunable quietHistBonusScale    = new Tunable("QuietHistBonusScale", 209, 50, 400, 25);
    private final Tunable quietHistMalusMax      = new Tunable("QuietHistMalusMax", 1231, 100, 2000, 100);
    private final Tunable quietHistMalusScale    = new Tunable("QuietHistMalusScale", 210, 50, 400, 25);
    private final Tunable quietHistMaxScore      = new Tunable("QuietHistMaxScore", 7724, 1000, 12000, 100);
    private final Tunable captHistBonusMax       = new Tunable("CaptHistBonusMax", 1194, 100, 2000, 100);
    private final Tunable captHistBonusScale     = new Tunable("CaptHistBonusScale", 202, 50, 400, 25);
    private final Tunable captHistMalusMax       = new Tunable("CaptHistMalusMax", 1154, 100, 2000, 100);
    private final Tunable captHistMalusScale     = new Tunable("CaptHistMalusScale", 199, 50, 400, 25);
    private final Tunable captHistMaxScore       = new Tunable("CaptHistMaxScore", 7960, 1000, 12000, 100);
    private final Tunable contHistBonusMax       = new Tunable("ContHistBonusMax", 1257, 100, 2000, 100);
    private final Tunable contHistBonusScale     = new Tunable("ContHistBonusScale", 218, 50, 400, 25);
    private final Tunable contHistMalusMax       = new Tunable("ContHistMalusMax", 1206, 100, 2000, 100);
    private final Tunable contHistMalusScale     = new Tunable("ContHistMalusScale", 202, 50, 400, 25);
    private final Tunable contHistMaxScore       = new Tunable("ContHistMaxScore", 8347, 1000, 12000, 100);
    private final Tunable timeFactor             = new Tunable("TimeFactor", 5, 3, 10, 1);
    private final Tunable incrementFactor        = new Tunable("IncrementFactor", 76, 50, 100, 5);
    private final Tunable softTimeFactor         = new Tunable("SoftTimeFactor", 66, 50, 70, 10);
    private final Tunable hardTimeFactor         = new Tunable("HardTimeFactor", 203, 150, 250, 10);
    private final Tunable softTimeScaleMin       = new Tunable("SoftTimeScaleMin", 12, 10, 25, 2);
    private final Tunable softTimeScaleMax       = new Tunable("SoftTimeScaleMax", 242, 100, 250, 50);
    ...
    private final Tunable nodeTmBase             = new Tunable("NodeTmBase", 155, 100, 200, 10);
    private final Tunable nodeTmScale            = new Tunable("NodeTmScale", 139, 100, 200, 10);
