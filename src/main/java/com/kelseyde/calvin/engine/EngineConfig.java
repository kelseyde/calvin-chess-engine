...
public class EngineConfig {
    ...
    private final Tunable fpMargin               = new Tunable("FpMargin", 200, 0, 500, 25);
    private final Tunable fpScale                = new Tunable("FpScale", 83, 0, 100, 5);
    private final Tunable fpHistDivisor          = new Tunable("FpHistDivisor", 274, 1, 1000, 25);
    ...
    private final Tunable qsFpMargin             = new Tunable("QsFpMargin", 99, 0, 250, 10);
    private final Tunable qsSeeThreshold         = new Tunable("QsSeeThreshold", 0, -300, 300, 100);
    ...
    private final Tunable lmrCapBase             = new Tunable("LmrCapBase", 90, 50, 100, 5);
    private final Tunable lmrCapDivisor          = new Tunable("LmrCapDivisor", 310, 200, 400, 10);
    ...
    private final Tunable lmrQuietHistoryDiv     = new Tunable("LmrQuietHistoryDiv", 6144, 1536, 12228, 1000);
    private final Tunable lmrNoisyHistoryDiv     = new Tunable("LmrNoisyHistoryDiv", 6144, 1536, 12228, 1000);
    ...
    private final Tunable dpMargin               = new Tunable("DpMargin", 111, 0, 250, 10);
    private final Tunable razorDepth             = new Tunable("RazorDepth", 4, 0, 8, 1);
    private final Tunable razorMargin            = new Tunable("RazorMargin", 496, 0, 600, 10);
    private final Tunable hpMaxDepth             = new Tunable("HpMaxDepth", 5, 0, 10, 1);
    private final Tunable hpMargin               = new Tunable("HpMargin", -4394, -6000, -100, 50);
    private final Tunable hpOffset               = new Tunable("HpOffset", -2078, -4000, 0, 50);
    private final Tunable ttExtensionDepth       = new Tunable("TtExtDepth", 6, 0, 12, 1);
    private final Tunable quietHistBonusMax      = new Tunable("QuietHistBonusMax", 2400, 100, 4000, 100);
    private final Tunable quietHistBonusScale    = new Tunable("QuietHistBonusScale", 400, 50, 800, 25);
    private final Tunable quietHistMalusMax      = new Tunable("QuietHistMalusMax", 2400, 100, 4000, 100);
    private final Tunable quietHistMalusScale    = new Tunable("QuietHistMalusScale", 400, 50, 800, 25);
    private final Tunable quietHistMaxScore      = new Tunable("QuietHistMaxScore", 16384, 1000, 12000, 100);
    private final Tunable captHistBonusMax       = new Tunable("CaptHistBonusMax", 2400, 100, 4000, 100);
    private final Tunable captHistBonusScale     = new Tunable("CaptHistBonusScale", 400, 50, 800, 25);
    private final Tunable captHistMalusMax       = new Tunable("CaptHistMalusMax", 2400, 100, 4000, 100);
    private final Tunable captHistMalusScale     = new Tunable("CaptHistMalusScale", 400, 50, 800, 25);
    private final Tunable captHistMaxScore       = new Tunable("CaptHistMaxScore", 16384, 1000, 12000, 100);
    private final Tunable contHistBonusMax       = new Tunable("ContHistBonusMax", 2400, 100, 4000, 100);
    private final Tunable contHistBonusScale     = new Tunable("ContHistBonusScale", 400, 50, 800, 25);
    private final Tunable contHistMalusMax       = new Tunable("ContHistMalusMax", 2400, 100, 4000, 100);
    private final Tunable contHistMalusScale     = new Tunable("ContHistMalusScale", 400, 50, 800, 25);
    private final Tunable contHistMaxScore       = new Tunable("ContHistMaxScore", 16384, 1000, 12000, 100);
    ...
    private final Tunable softTimeScaleMax       = new Tunable("SoftTimeScaleMax", 250, 100, 250, 50);
    ...
    private final Tunable nodeTmBase             = new Tunable("NodeTmBase", 150, 100, 200, 10);
    private final Tunable nodeTmScale            = new Tunable("NodeTmScale", 135, 100, 200, 10);
