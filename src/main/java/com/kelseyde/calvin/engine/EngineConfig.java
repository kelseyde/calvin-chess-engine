...
public class EngineConfig {
    ...
    private final Tunable rfpWorseningMargin     = new Tunable("RfpOppWorseningMargin", 69, 0, 150, 25);
    ...
    public Set<Tunable> getTunables() {
        return Set.of(
                ...
                seBetaMargin, seReductionOffset, seReductionDivisor, seDoubleExtMargin, rfpImprovingMargin, rfpWorseningMargin
        );
    }
