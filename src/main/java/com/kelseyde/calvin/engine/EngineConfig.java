...
public class EngineConfig {
    ...
    public Set<Tunable> getTunables() {
        return Set.of(
                ...
                seBetaMargin, seReductionOffset, seReductionDivisor, seDoubleExtMargin, plyHistBonusMax, plyHistBonusScale,
                plyHistMalusMax, plyHistMalusScale, plyHistMaxScore
        );
    }
