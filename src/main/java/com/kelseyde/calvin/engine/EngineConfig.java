...
public class EngineConfig {
    ...
    private final Tunable lmrNoGoodMoves         = new Tunable("LmrNoGoodMoves", 340, 0, 1024, 150);
    ...
    public Set<Tunable> getTunables() {
        return Set.of(
                ...
                seBetaMargin, seReductionOffset, seReductionDivisor, seDoubleExtMargin, lmrNoGoodMoves
        );
    }
    ...
    public int lmrNoGoodMoves() {
        return lmrNoGoodMoves.value;
    }
