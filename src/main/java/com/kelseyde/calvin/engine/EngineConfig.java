...
public class EngineConfig {
    ...
    private final Tunable rfpPrevPvNode          = new Tunable("RfpPrevPvNode", -20, -50, 50, 10);
    private final Tunable rfpPrevNotPvNode       = new Tunable("RfpPrevNotPvNode", 20, -50, 50, 10);
    ...
    public Set<Tunable> getTunables() {
        return Set.of(
                ...
                rfpImprovingMargin, rfpPrevPvNode, rfpPrevNotPvNode
        );
    }
    ...
    public int rfpPrevPvNode() {
        return rfpPrevPvNode.value;
    }

    public int rfpPrevNotPvNode() {
        return rfpPrevNotPvNode.value;
    }
