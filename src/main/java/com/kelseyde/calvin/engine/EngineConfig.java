...
public class EngineConfig {
    ...
    private final Tunable nmpDepth                = new Tunable("NmpDepth", 99, 0, 6144, 1024, true);
    ...
    private final Tunable fpDepth                 = new Tunable("FpDepth", 8040, 0, 10240, 1024, true);
    ...
    private final Tunable seeMaxDepth             = new Tunable("SeeMaxDepth", 10089, 6144, 12288, 1024, true);
    ...
    private final Tunable rfpDepth                = new Tunable("RfpDepth", 8626, 0, 12288, 1024, true);
    private final Tunable rfpMargin               = new Tunable("RfpMargin", 69, 0, 150, 25);
    private final Tunable lmrDepth                = new Tunable("LmrDepth", 1794, 0, 8192, 1024, true);
    ...
    private final Tunable lmrPvNode               = new Tunable("LmrPvNode", 933, 0, 2048, 150, true);
    private final Tunable lmrCutNode              = new Tunable("LmrCutNode", 2323, 0, 3072, 150, true);
    private final Tunable lmrNotImproving         = new Tunable("LmrNotImproving", 324, 0, 2048, 150, true);
    private final Tunable lmrFutile               = new Tunable("LmrFutile", 1061, 0, 2048, 150, true);
    ...
    private final Tunable lmpDepth                = new Tunable("LmpDepth", 8029, 0, 16384, 1024, true);
    private final Tunable lmpMultiplier           = new Tunable("LmpMultiplier", 8, 1, 20, 1);
    private final Tunable iirMinDepth             = new Tunable("IirMinDepth", 4204, 0, 8192, 1024, true);
    private final Tunable iirPvNodeReduction      = new Tunable("IirPvNodeReduction", 1211, 0, 3072, 1024, true);
    private final Tunable iirCutNodeReduction     = new Tunable("IirCutNodeReduction", 780, 0, 3072, 1024, true);
    private final Tunable dpMargin                = new Tunable("DpMargin", 98, 0, 250, 10);
    private final Tunable razorDepth              = new Tunable("RazorDepth", 4054, 0, 8192, 1024, true);
    private final Tunable razorMargin             = new Tunable("RazorMargin", 470, 0, 600, 10);
    private final Tunable hpMaxDepth              = new Tunable("HpMaxDepth", 5292, 0, 10240, 1024, true);
    ...
    private final Tunable seDepth                 = new Tunable("SeDepth", 8314, 0, 10240, 1024, true);
    private final Tunable seTtDepthMargin         = new Tunable("SeTtDepthMargin", 3064, 2048, 6144, 1024, true);
    ...
    private final Tunable checkExtension          = new Tunable("CheckExtension", 625, 0, 2048, 256, true);
    private final Tunable singularExtension       = new Tunable("SingularExtension", 1007, 0, 2048, 256, true);
    private final Tunable doubleExtension         = new Tunable("DoubleExtension", 2244, 1024, 3072, 256, true);
    private final Tunable negativeExtension       = new Tunable("NegativeExtension", -1047, -2048, 0, 256, true);
    private final Tunable doubleNegativeExtension = new Tunable("DoubleNegativeExtension", -2048, -3072, 0, 256, true);
    private final Tunable ttExtensionMaxDepth     = new Tunable("TtExtensionMaxDepth", 6088, 0, 12288, 1024, true);
    private final Tunable ttExtension             = new Tunable("TtExtension", 998, 0, 3072, 1024, true);
    private final Tunable ttCutoffPvReduction     = new Tunable("TtCutoffPvReduction", 941, 0, 3072, 1024, true);
    ...
    public Set<Tunable> getTunables() {
        return Set.of(
                ...
                lmrMinPvMoves, lmpDepth, lmpMultiplier, iirMinDepth, iirPvNodeReduction, iirCutNodeReduction, nmpBase,
                nmpDivisor, dpMargin, qsFpMargin, qsSeeThreshold, fpMargin, fpScale, rfpMargin, razorDepth, razorMargin,
    ...
    public Set<Tunable> getDepthTunables() {
        return getTunables().stream()
                .filter(t -> t.depthParam)
                .collect(toSet());
    }
    ...
    public static class Tunable {
        ...
        private final boolean depthParam;

        public Tunable(String name, int value, int min, int max, int step, boolean depthParam) {
            this.name = name;
            this.value = value;
            this.min = min;
            this.max = max;
    ...
    public int iirPvNodeReduction() {
        return iirPvNodeReduction.value;
    }

    public int iirCutNodeReduction() {
        return iirCutNodeReduction.value;
    }
