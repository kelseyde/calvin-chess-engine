...
public class EngineConfig {
    ...
    private final Tunable rootCorrplexityMinDepth = new Tunable("RootCorrplexityMinDepth", 0, 0, 10, 1);
    private final Tunable rootCorrplexityDivisor  = new Tunable("RootCorrplexityDivisor", 6, 1, 10, 1);
    ...
    private final int[] rootCorrplexityFactor = { 75, 80, 90, 100, 120, 250 };
    ...
    public int rootCorrplexityMinDepth() {
        return rootCorrplexityMinDepth.value;
    }

    public int[] rootCorrplexityFactor() {
        return rootCorrplexityFactor;
    }

    public int rootCorrplexityDivisor() {
        return rootCorrplexityDivisor.value;
    }
