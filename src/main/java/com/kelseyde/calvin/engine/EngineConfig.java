...
public class EngineConfig {
    ...
    public final Tunable qsSeeMargin             = new Tunable("QsSeeMargin", -98, -200, 1, 50);
    ...
    public Set<Tunable> getTunables() {
        return Set.of(
                ...
                qsSeeMargin, fpMargin, fpScale, rfpMargin, rfpImpMargin, rfpBlend, razorDepth, razorMargin,
