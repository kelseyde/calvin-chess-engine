...
public class EngineConfig {
    ...
    private final Tunable lmrCorrhistMul         = new Tunable("LmrCorrhistMul", 12288, 8192, 16384, 1024);
    ...
    public Set<Tunable> getTunables() {
        return Set.of(
                ...
                lmpImpBase, lmpImpScale, lmrFailHighCount, hindsightExtLimit, lmrCorrhistMul
        );
    }
    ...
    public int lmrCorrhistMul() {
        return lmrCorrhistMul.value;
    }
