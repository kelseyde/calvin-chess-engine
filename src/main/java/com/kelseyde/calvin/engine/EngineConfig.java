...
public class EngineConfig {
    ...
    private final Tunable quietHistBonusScale    = new Tunable("QuietHistBonusScale", 140, 50, 400, 25);
    private final Tunable quietHistMalusMax      = new Tunable("QuietHistMalusMax", 1200, 100, 2000, 100);
    private final Tunable quietHistMalusScale    = new Tunable("QuietHistMalusScale", 140, 50, 400, 25);
    ...
    private final Tunable captHistBonusScale     = new Tunable("CaptHistBonusScale", 140, 50, 400, 25);
    private final Tunable captHistMalusMax       = new Tunable("CaptHistMalusMax", 1200, 100, 2000, 100);
    private final Tunable captHistMalusScale     = new Tunable("CaptHistMalusScale", 140, 50, 400, 25);
    ...
    private final Tunable contHistBonusScale     = new Tunable("ContHistBonusScale", 140, 50, 400, 25);
    private final Tunable contHistMalusMax       = new Tunable("ContHistMalusMax", 1200, 100, 2000, 100);
    private final Tunable contHistMalusScale     = new Tunable("ContHistMalusScale", 140, 50, 400, 25);
