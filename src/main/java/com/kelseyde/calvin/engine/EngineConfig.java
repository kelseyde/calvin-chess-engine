...
public class EngineConfig {
    ...
    private final Tunable quietHistMaxScore      = new Tunable("QuietHistMaxScore", 16384, 1000, 16384, 100);
    ...
    private final Tunable captHistMaxScore       = new Tunable("CaptHistMaxScore", 16384, 1000, 16384, 100);
    ...
    private final Tunable contHistMaxScore       = new Tunable("ContHistMaxScore", 16384, 1000, 16384, 100);
