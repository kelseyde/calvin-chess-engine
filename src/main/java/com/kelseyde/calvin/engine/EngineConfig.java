...
public class EngineConfig {
    ...
    private final Tunable fpDepth                = new Tunable("FpDepth", 10, 0, 8, 1);
    ...
    private final Tunable lmpDepth               = new Tunable("LmpDepth", 9, 0, 16, 1);
    ...
    private final Tunable iirDepth               = new Tunable("IirDepth", 3, 0, 8, 1);
    private final Tunable dpMargin               = new Tunable("DpMargin", 98, 0, 250, 10);
    private final Tunable razorDepth             = new Tunable("RazorDepth", 5, 0, 8, 1);
    private final Tunable razorMargin            = new Tunable("RazorMargin", 470, 0, 600, 10);
    private final Tunable hpMaxDepth             = new Tunable("HpMaxDepth", 6, 0, 10, 1);
