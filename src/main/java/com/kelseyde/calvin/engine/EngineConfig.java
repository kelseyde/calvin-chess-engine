...
public class EngineConfig {
    ...
    private final Tunable quietHistBonusMax      = new Tunable("QuietHistBonusMax", 1205, 100, 2000, 100);
    private final Tunable quietHistBonusScale    = new Tunable("QuietHistBonusScale", 210, 50, 400, 25);
    private final Tunable quietHistMalusMax      = new Tunable("QuietHistMalusMax", 1186, 100, 2000, 100);
    private final Tunable quietHistMalusScale    = new Tunable("QuietHistMalusScale", 213, 50, 400, 25);
    private final Tunable quietHistMaxScore      = new Tunable("QuietHistMaxScore", 8192, 1000, 12000, 100);
    private final Tunable captHistBonusMax       = new Tunable("CaptHistBonusMax", 1188, 100, 2000, 100);
    private final Tunable captHistBonusScale     = new Tunable("CaptHistBonusScale", 221, 50, 400, 25);
    private final Tunable captHistMalusMax       = new Tunable("CaptHistMalusMax", 1236, 100, 2000, 100);
    private final Tunable captHistMalusScale     = new Tunable("CaptHistMalusScale", 186, 50, 400, 25);
    private final Tunable captHistMaxScore       = new Tunable("CaptHistMaxScore", 8192, 1000, 12000, 100);
    private final Tunable contHistBonusMax       = new Tunable("ContHistBonusMax", 1146, 100, 2000, 100);
    private final Tunable contHistBonusScale     = new Tunable("ContHistBonusScale", 194, 50, 400, 25);
    private final Tunable contHistMalusMax       = new Tunable("ContHistMalusMax", 1162, 100, 2000, 100);
