...
public class EngineConfig {
    ...
    private final Tunable rfpImpMargin           = new Tunable("RfpImpMargin", 69, 0, 150, 25);
    private final Tunable rfpComplexityDiv       = new Tunable("RfpComplexityDiv", 2, 1, 4, 1);
    ...
    public Set<Tunable> getTunables() {
        return Set.of(
                ...
                qsSeeThreshold, fpMargin, fpScale, rfpMargin, rfpImpMargin, razorDepth, razorMargin, hpMaxDepth,
                ...
                seBetaMargin, seReductionOffset, seReductionDivisor, seDoubleExtMargin, rfpComplexityDiv
        );
    }
    ...
    public int rfpComplexityDiv() {
        return rfpComplexityDiv.value;
    }
