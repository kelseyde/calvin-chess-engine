...
public class EngineConfig {
    ...
    private final Tunable lmrTtNoCutoff          = new Tunable("LmrFutile", 1024, 0, 2048, 150);
    ...
    public Set<Tunable> getTunables() {
        return Set.of(
                ...
                seBetaMargin, seReductionOffset, seReductionDivisor, seDoubleExtMargin, lmrTtNoCutoff
        );
    }
    ...
    public int lmrTtNoCutoff() {
        return lmrTtNoCutoff.value;
    }
