...
public class EngineConfig {
    ...
    private final Tunable rfpCutNodeMargin       = new Tunable("RfpCutNodeMargin", 20, 0, 60, 10);
    ...
    public Set<Tunable> getTunables() {
        return Set.of(
                ...
                rfpImprovingMargin, rfpCutNodeMargin
        );
    }
    ...
    public int rfpCutNodeMargin() {
        return rfpCutNodeMargin.value;
    }
