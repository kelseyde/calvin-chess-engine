...
public class PieceSquareTable {
    ...
    public static final int[] PAWN_ENDGAME_TABLE = new int[] {
                0,   0,   0,   0,   0,   0,   0,   0,
    ...
    public static final int[] KNIGHT_MIDDLEGAME_TABLE = new int[] {
    ...
    public static final int[] KNIGHT_ENDGAME_TABLE = new int[] {
    ...
    public static final int[] BISHOP_MIDDLEGAME_TABLE = new int[] {
    ...
    public static final int[] BISHOP_ENDGAME_TABLE = new int[] {
    ...
    public static final int[] ROOK_MIDDLEGAME_TABLE = new int[] {
    ...
    public static final int[] ROOK_ENDGAME_TABLE = new int[] {
    ...
    public static final int[] QUEEN_MIDDLEGAME_TABLE = new int[] {
    ...
    public static final int[] QUEEN_ENDGAME_TABLE = new int[] {
    ...
    public static final int[] KING_MIDDLEGAME_TABLE = new int[] {
    ...
    public static final int[] KING_ENDGAME_TABLE = new int[] {
