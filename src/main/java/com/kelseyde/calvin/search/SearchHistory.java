...
public class SearchHistory {
    ...
    private void updateQuietHistory(PlayedMove quietMove, PlayedMove bestMove, SearchStack ss, boolean white, int depth, int ply, long threats) {
        ...
        quietHistoryTable.update(quietMove.move(), depth, white, good, threats);
