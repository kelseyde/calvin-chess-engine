...
public class QuiescentMovePicker extends MovePicker {
    ...
    public QuiescentMovePicker(
            EngineConfig config, MoveGenerator movegen, SearchStack ss, SearchHistory history, Board board, int ply, Move ttMove, boolean inCheck, long threats) {
        super(config, movegen, ss, history, board, ply, ttMove, inCheck, threats);
