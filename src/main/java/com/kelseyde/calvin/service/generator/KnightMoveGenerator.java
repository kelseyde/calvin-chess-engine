...
@Service
public class KnightMoveGenerator implements LegalMoveGenerator {

    // All the possible candidate move offsets for a knight on a 1-dimensional board array, e.g., a knight in the middle
