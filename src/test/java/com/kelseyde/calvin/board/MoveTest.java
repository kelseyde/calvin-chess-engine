...
public class MoveTest {
    ...
    public void testPromotionPieceType() {
        ...
        Assertions.assertEquals(Piece.QUEEN, move.getPromoPiece());
        ...
        Assertions.assertEquals(Piece.ROOK, move.getPromoPiece());
        Assertions.assertTrue(move.isPromotion());
        Assertions.assertFalse(move.isCastling());
        Assertions.assertFalse(move.isPawnDoubleMove());
        Assertions.assertFalse(move.isEnPassant());
        ...
        Assertions.assertEquals(Piece.BISHOP, move.getPromoPiece());
        Assertions.assertTrue(move.isPromotion());
        Assertions.assertFalse(move.isCastling());
        Assertions.assertFalse(move.isPawnDoubleMove());
        Assertions.assertFalse(move.isEnPassant());
        ...
        Assertions.assertEquals(Piece.KNIGHT, move.getPromoPiece());
        Assertions.assertTrue(move.isPromotion());
        Assertions.assertFalse(move.isCastling());
        Assertions.assertFalse(move.isPawnDoubleMove());
        Assertions.assertFalse(move.isEnPassant());
