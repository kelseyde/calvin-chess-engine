...
public class EvaluatorTest {
    ...
    public void testSimpleUndoMove() {
        ...
        evaluator = new Evaluator(config, board);
    ...
    public void testCapture() {
        ...
        Assertions.assertEquals(new Evaluator(config, board).get(), evaluator.get());
    ...
    public void testMultipleUnmakeMove() {
        ...
        Assertions.assertEquals(evaluator.get(), new Evaluator(config, board).get());
