...
public class EvaluatorTest {
    ...
    public void testCapture() {
        ...
        Assertions.assertEquals(newEvaluator(board), evaluator.get());
    ...
    public void testPromotion() {
        ...
        Move move = new Move(Notation.fromNotation("g7"), Notation.fromNotation("g8"), Move.PROMOTE_TO_QUEEN_FLAG);
        board.makeMove(move);
        evaluator.makeMove(move);
        Assertions.assertEquals(newEvaluator(board), evaluator.get());
    ...
    public void testMultipleUnmakeMove() {
        ...
        Assertions.assertEquals(evaluator.get(), newEvaluator(board));
    ...
    public void testPromotionChangesEndgameWeightScore() {
        ...
        move = new Move(Notation.fromNotation("e7"), Notation.fromNotation("d8"), Move.PROMOTE_TO_ROOK_FLAG);
        board.makeMove(move);
        evaluator.makeMove(move);
        Assertions.assertEquals(newEvaluator(board), evaluator.get());
    ...
    private int newEvaluator(Board board) {
        Evaluation newEvaluator = new Evaluator(config);
        newEvaluator.init(board);
