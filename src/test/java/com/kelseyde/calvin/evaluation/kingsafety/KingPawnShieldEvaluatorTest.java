...
public class KingPawnShieldEvaluatorTest {
    ...
    public void testSimpleCastledKingFullPawnShield() {
        ...
        int eval = KingSafety.score(config, board, new Material(1, 1, 1, 1, 1), 1.0f, true);
    ...
    public void testKingSemiOpenFile() {
        ...
        int eval = KingSafety.score(config, board, new Material(8, 2, 2, 2, 1), 1.0f, true);
    ...
    public void testEndgameWeight() {
        ...
        int eval = KingSafety.score(config, board, new Material(1, 1, 1, 1, 1), phase, true);
        ...
        eval = KingSafety.score(config, board, new Material(1, 1, 1, 1, 0), phase, true);
        Assertions.assertEquals(-15, eval);
