...
public class KingPawnShieldEvaluatorTest {
    ...
    public void testSimpleCastledKingFullPawnShield() {
        ...
        Material material = Material.fromBoard(board, false);

        int eval = KingSafety.score(config, board, material, 1.0f, true);
    ...
    public void testH3Hook() {
        ...
        Board board = FEN.toBoard(fen);
        Material material = Material.fromBoard(board, true);
    ...
    public void testEndgameWeight() {
        ...
        int eval = KingSafety.score(config, board, material, phase, true);
        ...
        material = Material.fromBoard(board, false);

        // remove opponent queen, -26.25 * 0.6 = -15.75
        eval = KingSafety.score(config, board, material, phase, true);
        Assertions.assertEquals(-15, eval);
