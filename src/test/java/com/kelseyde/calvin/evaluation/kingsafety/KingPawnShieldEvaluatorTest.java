...
public class KingPawnShieldEvaluatorTest {
    ...
    private final KingPawnShieldEvaluator evaluator = new KingPawnShieldEvaluator();
    ...
    public void testSimpleCastledKingFullPawnShield() {
        ...
        int eval = evaluator.evaluate(board, new Material(1, 1, 1, 1, 1, 1.0f, 1), true);
    ...
    public void testH3Hook() {
        ...
        int eval = evaluator.evaluate(board, new Material(1, 1, 1, 1, 1, 1f, 1), true);
    ...
    public void testKingSemiOpenFile() {
        ...
        int eval = evaluator.evaluate(board, new Material(8, 2, 2, 2, 1, 1f, 1), true);
    ...
    public void testEndgameWeight() {
        ...
        int eval = evaluator.evaluate(board, new Material(1, 1, 1, 1, 1, phase, 1), true);
        ...
        eval = evaluator.evaluate(board, new Material(1, 1, 1, 1, 0, phase, 1), true);
        Assertions.assertEquals(-15, eval);
