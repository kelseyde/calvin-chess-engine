...
public class PawnEvaluationTest {
    ...
    public void testSinglePassedPawn() {
        ...
        board = FEN.toBoard(fen);
        Assertions.assertEquals(200, score(board));

        fen = "4k3/P7/8/8/8/8/8/4K3 w - - 0 1";
        board = FEN.toBoard(fen);
        Assertions.assertEquals(280, score(board));
    ...
    public void testSingleProtectedPassedPawn() {
        ...
        Board board = FEN.toBoard(fen);
        //100 + (25)
        Assertions.assertEquals(225, score(board));

        fen = "4k3/8/6p1/6Pp/5P2/8/8/4K3 w - - 0 1";
        board = FEN.toBoard(fen);
        //30 + (25)
        Assertions.assertEquals(-85, score(board));
    ...
    public void testDoubleProtectedPassedPawn() {
        ...
        board = FEN.toBoard(fen);
        Assertions.assertEquals(-250, score(board));
