...
public class PawnEvaluatorTest {
    ...
    public void testSinglePassedPawn() {
        ...
        Assertions.assertEquals(15, evaluator.evaluate(board, 1));
        ...
        board = FEN.fromFEN(fen);
        Assertions.assertEquals(30, evaluator.evaluate(board, 1));

        fen = "4k3/8/8/P7/8/8/8/4K3 w - - 0 1";
        board = FEN.fromFEN(fen);
        Assertions.assertEquals(50, evaluator.evaluate(board, 1));

        fen = "4k3/8/P7/8/8/8/8/4K3 w - - 0 1";
        board = FEN.fromFEN(fen);
        Assertions.assertEquals(80, evaluator.evaluate(board, 1));

        fen = "4k3/P7/8/8/8/8/8/4K3 w - - 0 1";
        board = FEN.fromFEN(fen);
        Assertions.assertEquals(120, evaluator.evaluate(board, 1));
    ...
    public void testSingleProtectedPassedPawn() {
        ...
        Board board = FEN.fromFEN(fen);
        //80 + (25)
        Assertions.assertEquals(105, evaluator.evaluate(board, 1));

        fen = "4k3/8/6p1/6Pp/5P2/8/8/4K3 w - - 0 1";
        board = FEN.fromFEN(fen);
        //30 + (25)
        Assertions.assertEquals(-55, evaluator.evaluate(board, 1));
    ...
    public void testDoubleProtectedPassedPawn() {
        ...
        Board board = FEN.fromFEN(fen);
        //50 + (2 * 25)
        Assertions.assertEquals(100, evaluator.evaluate(board, 1));

        fen = "4k3/8/8/8/1p1p4/1PpP4/P3P3/4K3 w - - 0 1";
        board = FEN.fromFEN(fen);
        //80 + (2 * 25)
        Assertions.assertEquals(-130, evaluator.evaluate(board, 1));
    ...
    public void testIsolatedPawnPenalty() {
        ...
        Board board = FEN.fromFEN(fen);
        Assertions.assertEquals(-10, evaluator.evaluate(board, 1));

        fen = "4k3/2pp2pp/8/8/8/8/2P1PP1P/4K3 w - - 0 1";
        board = FEN.fromFEN(fen);
        Assertions.assertEquals(-25, evaluator.evaluate(board, 1));
    ...
    public void testDoubledPawnsPenalty() {
        ...
        Assertions.assertEquals(-40, evaluator.evaluate(board, 1));
    ...
    public void testDoubledIsolatedPawnsPenalty() {
        ...
        Assertions.assertEquals(-170, evaluator.evaluate(board, 1));
