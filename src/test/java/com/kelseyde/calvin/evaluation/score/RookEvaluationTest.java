...
public class RookEvaluationTest {
    ...
    public void testBothPawnsThenNoBonus() {
        ...
        Assertions.assertEquals(0, RookEvaluation.score(board, 1, true));
        Assertions.assertEquals(0, RookEvaluation.score(board, 1, false));
    ...
    public void testSemiOpenFile() {
        ...
        Assertions.assertEquals(18, RookEvaluation.score(board, 1, true));
        Assertions.assertEquals(18, RookEvaluation.score(board, 1, false));
    ...
    public void testOpenFile() {
        ...
        Assertions.assertEquals(42, RookEvaluation.score(board, 1, true));
        Assertions.assertEquals(42, RookEvaluation.score(board, 1, false));
