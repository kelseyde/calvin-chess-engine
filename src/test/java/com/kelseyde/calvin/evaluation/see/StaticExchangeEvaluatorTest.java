...
public class StaticExchangeEvaluatorTest {
    ...
    public void testSimpleCapturePawn() {
        ...
        Move move = NotationUtils.fromNotation("e4", "d5", PieceType.PAWN);
    ...
    public void testSimpleCaptureKnight() {
        ...
        Board board = FEN.fromFEN(fen);
        Move move = NotationUtils.fromNotation("d5", "e4", PieceType.KNIGHT);
    ...
    public void testSimpleCaptureBishop() {
        ...
        Board board = FEN.fromFEN(fen);
        Move move = NotationUtils.fromNotation("e4", "d5", PieceType.BISHOP);
    ...
    public void testSimpleCaptureRook() {
        ...
        Board board = FEN.fromFEN(fen);
        Move move = NotationUtils.fromNotation("d6", "e4", PieceType.KNIGHT);
    ...
    public void testSimpleCaptureQueen() {
        ...
        Board board = FEN.fromFEN(fen);
        Move move = NotationUtils.fromNotation("e4", "d5", PieceType.KING);
    ...
    public void testLoseQueenForPawn() {
        ...
        Board board = FEN.fromFEN(fen);
        Move move = NotationUtils.fromNotation("e4", "d5", PieceType.QUEEN);
    ...
    public void testWinPieceQueenChoosesNotToRecapture() {
        ...
        Board board = FEN.fromFEN(fen);
        Move move = NotationUtils.fromNotation("c7", "d5", PieceType.KNIGHT);
    ...
    public void testXRayedPiecesCountToo() {
        ...
        Board board = FEN.fromFEN(fen);
        Move move = NotationUtils.fromNotation("b3", "d5", PieceType.BISHOP);
    ...
    public void testMultipleRookXrays() {
        ...
        Board board = FEN.fromFEN(fen);
        Move move = NotationUtils.fromNotation("d4", "e4", PieceType.ROOK);

        int score = see.evaluate(board, move);

        Assertions.assertEquals(-400, score);

        move = NotationUtils.fromNotation("d4", "c4", PieceType.ROOK);
    ...
    public void testOrderOfCapturesMatters() {
        ...
        move = NotationUtils.fromNotation("c4", "d5", PieceType.QUEEN);
