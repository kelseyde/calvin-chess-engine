...
public class QuiescentTest {
    ...
    public void testGenerateKnightMoves() {
        ...
        List<Move> moves = Arrays.asList(moveGenerator.generateMoves(board, MoveGeneration.MoveFilter.CAPTURES_ONLY));
        ...
        moves = Arrays.asList(moveGenerator.generateMoves(board, MoveGeneration.MoveFilter.NOISY));
        expected = List.of(
                Notation.fromNotation("a6", "b7"),
                Notation.fromNotation("f8", "d7"),
                Notation.fromNotation("f8", "h7"),
