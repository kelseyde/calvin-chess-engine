...
public class PinCalculatorTest {
    ...
    public void testNoSlidersAndNoPins() {
        ...
        long pinned = Board.pinned(board, true);
        Assertions.assertEquals(0L, pinned);

        pinned = Board.pinned(board, false);
        Assertions.assertEquals(0L, pinned);
    ...
    public void testSimplePositiveFileOrthogonalPin() {
        ...
        long pinned = Board.pinned(board, true);
        Assertions.assertEquals(1L << 12, pinned);
    ...
    public void testSimpleNegativeFileOrthogonalPin() {
        ...
        pinned = Board.pinned(board, false);
        Assertions.assertEquals(1L << 52, pinned);
    ...
    public void testFileOrthogonalTwoWayPin() {
        ...
        long pinned = Board.pinned(board, true);
        Assertions.assertEquals(1L << 19, pinned);

        pinned = Board.pinned(board, false);
        Assertions.assertEquals(1L << 43, pinned);
    ...
    public void testFileOrthogonalDoubleOpponentPinIsStillPin() {
        ...
        long pinned = Board.pinned(board, true);
        Assertions.assertEquals(1L << 28, pinned);
    ...
    public void testSimplePositiveRankOrthogonalPin() {
        ...
        pinned = Board.pinned(board, false);
        Assertions.assertEquals(1L << 62, pinned);
    ...
    public void testSimpleNegativeRankOrthogonalPin() {
        ...
        long pinned = Board.pinned(board, true);
        Assertions.assertEquals(1L << 57, pinned);
    ...
    public void testSimplePositiveDiagonalPin() {
        ...
        pinned = Board.pinned(board, false);
        Assertions.assertEquals(1L << 37, pinned);
    ...
    public void testSimpleNegativeDiagonalPin() {
        ...
        pinned = Board.pinned(board, false);
        Assertions.assertEquals(1L << 18, pinned);
    ...
    public void testSimplePositiveAntiDiagonalPin() {
        ...
        pinned = Board.pinned(board, false);
        Assertions.assertEquals(1L << 54, pinned);
    ...
    public void testTwoWayAntiDiagonalPin() {
        ...
        long pinned = Board.pinned(board, true);
        Assertions.assertEquals(1L << 36, pinned);

        pinned = Board.pinned(board, false);
        Assertions.assertEquals(1L << 27, pinned);
    ...
    public void testBothSidesOrthogonalRankPin() {
        ...
        long pinned = Board.pinned(board, true);
        Assertions.assertEquals(expectedPinMask, pinned);
    ...
    public void testBothSidesDiagonalPin() {
        ...
        long pinned = Board.pinned(board, true);
        Assertions.assertEquals(1L << 42, pinned);
    ...
    public void testCrazyPinsEverywhere() {
        ...
        long pinned = Board.pinned(board, true);
        Assertions.assertEquals(expectedWhitePinMask, pinned);

        pinned = Board.pinned(board, false);
        Assertions.assertEquals(expectedBlackPinMask, pinned);
