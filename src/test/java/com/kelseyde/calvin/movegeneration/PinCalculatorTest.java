...
public class PinCalculatorTest {
    ...
    public void testSimplePositiveFileOrthogonalPin() {
        ...
        Assertions.assertEquals(1L << 12, calculator.calculatePinMask(board, true));
        Assertions.assertEquals(0L, calculator.calculatePinMask(board, false));
    ...
    public void testSimpleNegativeFileOrthogonalPin() {
        ...
        Assertions.assertEquals(0L, calculator.calculatePinMask(board, true));
        Assertions.assertEquals(1L << 52, calculator.calculatePinMask(board, false));
    ...
    public void testFileOrthogonalTwoWayPin() {
        ...
        Assertions.assertEquals(1L << 19, calculator.calculatePinMask(board, true));
        Assertions.assertEquals(1L << 43, calculator.calculatePinMask(board, false));
    ...
    public void testFileOrthogonalDoubleOpponentPinIsStillPin() {
        ...
        Assertions.assertEquals(1L << 28, calculator.calculatePinMask(board, true));
        Assertions.assertEquals(0L, calculator.calculatePinMask(board, false));
    ...
    public void testSimplePositiveRankOrthogonalPin() {
        ...
        Assertions.assertEquals(0L, calculator.calculatePinMask(board, true));
        Assertions.assertEquals(1L << 62, calculator.calculatePinMask(board, false));
    ...
    public void testSimpleNegativeRankOrthogonalPin() {
        ...
        Assertions.assertEquals(1L << 57, calculator.calculatePinMask(board, true));
        Assertions.assertEquals(0, calculator.calculatePinMask(board, false));
    ...
    public void testSimplePositiveDiagonalPin() {
        ...
        Assertions.assertEquals(0L, calculator.calculatePinMask(board, true));
        Assertions.assertEquals(1L << 37, calculator.calculatePinMask(board, false));
    ...
    public void testSimpleNegativeDiagonalPin() {
        ...
        Assertions.assertEquals(0L, calculator.calculatePinMask(board, true));
        Assertions.assertEquals(1L << 18, calculator.calculatePinMask(board, false));
    ...
    public void testDiagonalDoubleFriendlyPinEqualsNoPin() {
        ...
        Assertions.assertEquals(0, calculator.calculatePinMask(board, true));
        Assertions.assertEquals(0, calculator.calculatePinMask(board, false));
    ...
    public void testSimplePositiveAntiDiagonalPin() {
        ...
        Assertions.assertEquals(0, calculator.calculatePinMask(board, true));
        Assertions.assertEquals(1L << 54, calculator.calculatePinMask(board, false));
    ...
    public void testSimpleNegativeAntiDiagonalPin() {
        ...
        Assertions.assertEquals(1L << 52, calculator.calculatePinMask(board, true));
        Assertions.assertEquals(0L, calculator.calculatePinMask(board, false));
    ...
    public void testTwoWayAntiDiagonalPin() {
        ...
        Assertions.assertEquals(1L << 36, calculator.calculatePinMask(board, true));
        Assertions.assertEquals(1L << 27, calculator.calculatePinMask(board, false));
    ...
    public void testBothSidesOrthogonalRankPin() {
        ...
        Assertions.assertEquals(expectedPinMask, calculator.calculatePinMask(board, true));
        Assertions.assertEquals(0L, calculator.calculatePinMask(board, false));
    ...
    public void testBothSidesOrthogonalFilePin() {
        ...
        Assertions.assertEquals(0L, calculator.calculatePinMask(board, true));
        Assertions.assertEquals(expectedPinMask, calculator.calculatePinMask(board, false));
    ...
    public void testBothSidesDiagonalPin() {
        ...
        Assertions.assertEquals(1L << 42, calculator.calculatePinMask(board, true));
        Assertions.assertEquals(expectedPinMask, calculator.calculatePinMask(board, false));
    ...
    public void testCrazyPinsEverywhere() {
        ...
        Assertions.assertEquals(expectedWhitePinMask, calculator.calculatePinMask(board, true));
        Assertions.assertEquals(expectedBlackPinMask, calculator.calculatePinMask(board, false));
