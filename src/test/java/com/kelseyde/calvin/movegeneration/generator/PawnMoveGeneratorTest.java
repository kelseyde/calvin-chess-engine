...
public class PawnMoveGeneratorTest {
    ...
    public void testWhiteEnPassant() {
        ...
        List<Move> legalWhiteMoves = generator.generatePseudoLegalMoves(board, 0L, 0);
    ...
    public void testBlackEnPassant() {
        ...
        List<Move> legalBlackMoves = generator.generatePseudoLegalMoves(board, 0L, 0);
    ...
    public void testWhiteStandardPromotion() {
        ...
        List<Move> legalMoves = generator.generatePseudoLegalMoves(board, 0L, 0);
    ...
    private void assertMoves(Board board, Set<Move> expected) {
        List<Move> actual = generator.generatePseudoLegalMoves(board, 0L, 0);
    ...
    private void assertMovesFromSquare(Board board, int square, Set<Move> expected) {
        List<Move> actual = generator.generatePseudoLegalMoves(board, 0L, 0).stream()
