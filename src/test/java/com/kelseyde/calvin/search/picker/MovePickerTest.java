...
public class MovePickerTest {
    ...
    public void testMoveOrder() {
        ...
        for (String fen : fens) {
            ...
            MovePicker picker = new MovePicker(TestUtils.CONFIG, moveGenerator, ss, history, board, 0, 0L, ttMove, false);
    ...
    public void testMoveOrderQsearch() {
        ...
        for (String fen : fens) {
            ...
            QuiescentMovePicker picker = new QuiescentMovePicker(TestUtils.CONFIG, moveGenerator, ss, history, board, 0, 0L, ttMove, false);
    ...
    public void testInCheckDoesNotGenerateMovesTwice() {
        ...
        MovePicker picker = new MovePicker(TestUtils.CONFIG, moveGenerator, new SearchStack(), new SearchHistory(new EngineConfig()), board, 0, 0L, null, true);
