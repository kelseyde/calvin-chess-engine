...
public class TranspositionTableTest {
    ...
    public void testSimplePutAndGetExact() {
        ...
        table.put(null, board.getState().getKey(), flag, depth, ply, bestMove,  0, eval);
        ...
        eval = 28666;
        depth = 256;
        table.put(null, board.getState().getKey(), flag, depth, ply + 1, bestMove, 0,  eval);
        ...
        eval = 1000000;
        depth = 10;
        table.put(null, board.getState().getKey(), flag, depth, ply + 2, null, 0,  eval);
    ...
    public void testStoreCheckmateAtRoot() {
        ...
        table.put(null, board.getState().getKey(), flag, plyRemaining, plyFromRoot, bestMove, 0,  1000000);

        Assertions.assertEquals(1000000, table.get(board.getState().getKey(), 0).score());

        table.put(null, board.getState().getKey(), flag, plyRemaining + 1, plyFromRoot, bestMove, 0,  -1000000);
    ...
    public void testScorePositiveCheckmateThenAccessFromDeeperPly() {
        ...
        table.put(null, board.getState().getKey(), flag, plyRemaining, plyFromRoot, bestMove, 0,  eval);
    ...
    public void testStoreOnlyStaticEvalInTt() {
        ...
        table.put(null, key, flag, depth, ply, null, eval, score);
